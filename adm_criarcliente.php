...
<body>
 <! -- Código realizado por Beatriz Franco e interface feita por Tomás Conti-->
<div class="login">
        <div class="formulario">
                <center><img src="cadastro_preto.png" width="200px"></center>
                <form action="adm_inserelogin.php" method="get">
                    <font size="4" face="arial"><br><br>  
                        <input type="radio" name="classificacao" value="administrador" id="administrador" required>Administrador&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="radio" name="classificacao" value="clientes" style="margin-left:-43px" required>Cliente<br>
                    ...
                    <div id="dois">
                        ...
                        <div class="telefone">
                            <input maxlength="2" name="ddd" id="ddd" pattern="[0-9]{2}" placeholder="DDD" title="Digite dois numeros" required/>&nbsp;
