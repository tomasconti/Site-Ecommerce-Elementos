...
if ( $qtde == 0 )
{
echo "Cliente não foi encontrado  !!!<br><br>";
exit;
}
    ...
    <div class="login">
        <div class="usuario_infos">
            <div class="formulario">
                ...
                <form action="grava_cliente_editado.php" method="post">
                    <div id="dois2">
            ...
            <center><a href='adm_usuario.php'><input type='button' value='Voltar'></a>&nbsp; 
