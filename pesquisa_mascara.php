    ...
    <center><div class="mae_produtos">
        <div class="topo">
            <div class="cabecalho">
                ...
                <div class="opcao">
                    <div>
                    <a href="carrinho.html"><img src="icone_carrinho.png" width="40px" height="40px"><br><p>CARRINHO</p></a></div>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
if($preco == "")
{
	...
	$sql="SELECT * FROM produto WHERE excluido='n' AND UPPER(nome) LIKE UPPER('$nome%') INTERSECT 
	SELECT * FROM produto WHERE excluido='n' AND UPPER(descricao) LIKE UPPER('$descricao%') INTERSECT
	SELECT * FROM produto WHERE excluido='n' AND UPPER(cor) LIKE UPPER('$cor%') INTERSECT
	SELECT * FROM produto WHERE excluido='n' AND tamanho LIKE '$tamanho%' INTERSECT
	SELECT * FROM produto WHERE excluido='n' AND UPPER(material) LIKE UPPER('$material%') INTERSECT
	SELECT * FROM produto WHERE excluido='n' AND preco <= '$preco';";
	$resultado= pg_query($conecta, $sql);
	...
	if ($qtde > 0)
	{
		...
		for ($cont=0; $cont < $qtde; $cont++)
		{
            ...
            $valor = number_format($linha['preco'], 2, ',', '.');
  			...
  			echo '<a id="prod" href="produto_escolhido.php?linha='.$linha["idproduto"].'"><br>
                    <img src="'.$foto.'" width="200" height="200"><br>
                    <p><b>Máscara'.$linha['nome'].'</b><br>
                    <b>'.$valor.'</b></p><br><br><br>
                    </a>';
